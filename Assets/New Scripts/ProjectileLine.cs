...
public class ProjectileLine : MonoBehaviour
{
    ...
    //This is a property (that is, a method masquerading as a filed
    public GameObject poi
    {
        ...
        set
        {
            ...
            if(_poi != null)
            {
                //When _poi us set to something new, it resets everything
                line.enabled = false;
                points = new List<Vector3>();
                AddPoint();
            }
    ...
    public void AddPoint()
    {
        ...
        if(points.Count == 0)
        {
            ...
            Vector3 launchPosDiff = pt - NewSlingShot.LAUNCH_POS; //To be defined
    ...
    public Vector3 lastPoint
    {
        get
        {
            if (points == null)
            {
                //If there are no points, returns Vector.zero
                return (Vector3.zero);
            }
	...
	void FixedUpdate () {
        ...
        //If there is a poi, it's poi is added every FixedUpdate
        AddPoint();
        if(FollowCam.POI == null)
        {
